...
DATA_PATH = os.path.join(mimicsql_natural, 'train.csv')

MODEL_PATH = "./final_model"
ADAPTER_PATH = "./lora_adapters34B"
...
class FineTuner:
    ...
    def finetune(self, data_path, training_args):
        ...
        try:
            ...
            #load_dataset("csv", data_files=os.path.join(mimicsql_natural, 'train.csv'))
...
import wandb
os.environ["WANDB_NOTEBOOK_NAME"] = 'finetuning1'
